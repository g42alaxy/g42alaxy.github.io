...
(async function() {
  const availableThemes = ['bulky', 'kubrik', 'bright', 'dark', 'minimal', 'seagreens', 'skyblues'];
...
async function initializeContent() {
  try {
    ...
    const socialIconMap = {
      ...
      scholar: `<svg class="social-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d="M12 2L1 7l11 5 9-4.09V11h2V7L12 2zm0 11L3 9v7c0 3.31 3.13 6 7 6h4c3.87 0 7-2.69 7-6V9l-9 4z"/></svg>`,
      orcid: `<svg class="social-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d="M12 0C5.373 0 0 5.373 0 12c0 6.628 5.373 12 12 12s12-5.372 12-12C24 5.373 18.627 0 12 0zM9.449 17.158H7.641V8.372h1.808v8.786zM8.545 7.396c-.579 0-1.048-.471-1.048-1.048 0-.579.469-1.048 1.048-1.048.577 0 1.048.469 1.048 1.048 0 .577-.471 1.048-1.048 1.048zM17.043 17.158h-1.75l-3.748-8.786h1.975l2.652 6.601 2.652-6.601h1.882l-3.663 8.786z"/></svg>`,
      telegram: `<svg class="social-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d="M9.997 15.584 9.883 19c.347 0 .498-.15.677-.33l1.627-1.556 3.376 2.476c.619.341 1.063.162 1.222-.573l2.213-10.409c.202-.935-.339-1.303-.945-1.075L3.554 10.56c-.914.354-.9.864-.156 1.097l3.963 1.238 9.205-5.75c.433-.26.828-.12.503.14l-7.072 6.3Z"/></svg>`,
